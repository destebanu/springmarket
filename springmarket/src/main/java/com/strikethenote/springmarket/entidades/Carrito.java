...
public class Carrito {
	...
	private Double descuentoProductoCarrito;
	...
	public Carrito(Producto producto, Integer cantidadProductoCarrito) {
		...
		setDescuentoProductoCarrito(producto.getDescuentoProducto());
		setCantidadProductoCarrito(cantidadProductoCarrito);
	}
	...
	public Double getDescuentoProductoCarrito() {
		return descuentoProductoCarrito;
	}

	public void setDescuentoProductoCarrito(Double descuentoProductoCarrito) {
		this.descuentoProductoCarrito = descuentoProductoCarrito;
	}
